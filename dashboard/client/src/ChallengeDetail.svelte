...
<div class="d-flex justify-content-between align-items-center ms-2 pt-4">
  <div>
    <h4 class="d-inline">{challenge.name}</h4>
  </div>
</div>
<p class="text-muted pt-3">{challenge.description}</p>

<div
  class="alert d-flex justify-content-between align-items-center me-2 {challenge.running
    ? 'alert-success'
    : 'alert-light'}"
  role="alert"
>
  <div class="d-flex align-items-center">
    {#if challenge.running}
      <div class="spinner-grow text-success slow-spinner me-2" role="status">
  ...
  <div class="card {task.solved ? 'border-success' : ''} mb-3 me-2">
    ...
    <div class="card-body">
      ...
      <div class="input-group mb-3">
        ...
        <button
          disabled={!challenge.running || task.solved}
