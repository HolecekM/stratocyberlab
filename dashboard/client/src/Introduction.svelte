<div class="d-flex justify-content-center pt-5">
  <div class="bg-body mb-5 rounded p-3 text-center shadow" style="max-width: 700px;">
    ...
    <p class="mb-3 text-start">The dashboard offers:</p>

    <ul class="mb-4 text-start" style="list-style-type: decimal; padding-left: 20px;">
      <li>
        Built-in terminal to your <b>hackerlab</b> machine
        <ul class="mb-4 text-start" style="list-style-type: disc; padding-left: 20px;">
      ...
      <li class="mb-2">
        ...
        <ul class="small mb-4 text-start" style="list-style-type: disc; padding-left: 20px;">
